# 1. 변수 초기화 (1번 구간)
# "먼저, 가장 느린 응답 시간을 기록할 max_time을 -1로 초기화했습니다. 0이 아닌 -1로 
...
# "전체 로직은 while True 무한 루프로 동작하며 사용자의 입력을 기다립니다. 
...
while True:
    ...
    # "가장 중요한 '응답 시간' 입력 구간입니다. 여기서는 중첩 while 루프와 파이썬의 
    ...
    # "검증이 끝난 데이터는 현재의 max_time과 비교합니다. 
